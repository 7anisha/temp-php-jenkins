  ...
  <nav class="navbar navbar-expand-lg navbar-light sticky-top" style="background-color:#273f7f ;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <a class="nav-link" class="btn btn-success mx-2" role="button" style="color:azure ;" href="index.php">Home</a> <span class="sr-only">(current)</span></a>
        </li>
        ...
        <li class="nav-item active">
          <a class="nav-link" style="color:rgb(189, 201, 201) ;" href="contactus.php">Contact Us</a>
        </li>
      ...
      <div class="=mx2">
        ...
        <a class="btn btn-success mx-2" role="button" aria-pressed="true"  href="registration.php">Registration</a>
        <a class="btn btn-danger mx-2" role="button" aria-pressed="true" href="login.php">login</a>
        <a class="btn btn-danger mx-2" role="button" aria-pressed="true" href="signup.php">signup</a>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item active">
          <img src="piet2.jpg" class="d-block w-100" alt="..." width="1920" height="700">
          ...
          <div class="carousel-caption d-none d-md-block" style="margin-left:5px">
            ...
            <div class="jumbotron p-2 my-1 text-black"
              ...
              <div class="banner-area">
                <h2
                  style="margin-top:9px;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif  ;font-weight: bolder;font-size:32px;">
                  Welcome to <span class="typed2"></span></h2>
              </div>
        ...
        <div class="carousel-item">
          <img src="piet1.jpg" class="d-block w-100" alt="..." width="1920" height="700">
          <div class="carousel-caption d-none d-md-block">
            <!-- <div class="container p-2 my-1 bg-dark text-white"></div> -->
            <div class="jumbotron p-2 my-1 text-black"
              style="width: 50%; height:fit-content;  background-color:#04206cbc; margin-left: 270px;">
              <h5 style="font-family:'Times New Roman', Times, serif;font-size: 23px;font-size: 25px;margin-top: 9px;">
                <b>PIET</b>
              </h5>
              <p
                style="text-align:center;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif ;font-weight: bolder;font-size:32px;">
        ...
        <div class="carousel-item">
          <img src="piet3.jpg" class="d-block w-100" alt="..." width="1920" height="700">
          <div class="carousel-caption d-none d-md-block">
            <!-- <div class="container p-2 my-1 bg-dark text-white"></div> -->
            <div class="jumbotron p-2 my-1 text-black"
              style="width: 50%; height:fit-content;  background-color:#04206cbc; margin-left: 270px;">
    ...
    <div class="jumbotron" id="about">
      <div class="container">
        ...
        <p>Poornima Institute of Engineering & Technology established in 2007 is putting its full potential in all
          ...
          Engineering block has a state-of-art infrastructure. The students of PIET have a number opportunities to
          fulfil
          their academic skills, one tune & aesthetic senses and work towards building the holistic culture that values
          the individuality of each student, thus helping them realize their innate potential. Here, at Poornima
          Institute
          of Engineering and Technology, Jaipur we believe in the openness of mind, the dignity of conduct, discipline
          and
          ...
          Department of Civil Engineering is located in the basement of the new building. The department is
          well-equipped
          with laboratories and airy lecture theatres. Online examination lab is located on the ground floor of the new
          building, where online examinations of all the semesters are conducted according to the pre-decided schedule.
          It
          ...
          Department of Computer Engineering is located separately in the other building in block three. The new
          building
